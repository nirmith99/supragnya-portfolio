    ...
    >
      <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
        ...
        <nav className="flex flex-wrap items-center gap-6 md:gap-8 text-sm text-[#C0C0C0]">
          ...
          <Link href="/about" className="transition-colors duration-250 hover:text-white hover:font-medium">
            About
          </Link>
          <Link
            href="/#selected-work"
            className="transition-colors duration-250 hover:text-white hover:font-medium"
          >
            Work
          </Link>
          <a
